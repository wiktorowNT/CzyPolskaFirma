  ...
  const categoriesData = [
    {
      ...
      companies: [
        { name: "Dino", company: "Dino Polska S.A.", index: 84, badges: [">50% kapitału PL", "CIT w PL: tak"] },
        { name: "POLOmarket", company: "POLOmarket S.A.", index: 78, badges: ["Siedziba w PL"] },
        { name: "Topaz", company: "PHU Topaz", index: 76, badges: ["Zatrudnia w PL"] },
      ],
    },
    {
      title: "RTV/AGD",
      ...
      companies: [
        { name: "RTV EURO AGD", company: "EURO‑NET sp. z o.o.", index: 80, badges: [">50% kapitału PL"] },
        { name: "Media Expert", company: "TERG S.A.", index: 82, badges: ["Zatrudnia w PL"] },
        { name: "x‑kom", company: "x‑kom sp. z o.o.", index: 74, badges: ["R&D w PL"] },
      ],
    },
    {
      title: "Moda",
      ...
      link: "/kategoria/moda",
      companies: [
        { name: "4F", company: "OTCF S.A.", index: 86, badges: ["R&D w PL"] },
        { name: "Reserved", company: "LPP S.A.", index: 72, badges: ["Marka z PL", "Siedziba w PL"] },
        { name: "House", company: "LPP S.A.", index: 70, badges: ["Marka z PL"] },
      ],
    },
    {
      ...
      companies: [
        ...
        { name: "Bielenda", company: "Bielenda Sp. z o.o.", index: 82, badges: ["R&D w PL"] },
        { name: "AA", company: "Oceanic S.A.", index: 78, badges: ["Siedziba w PL"] },
      ],
    },
    {
      ...
      companies: [
        { name: "PKO Bank Polski", company: "PKO BP S.A.", index: 85, badges: ["CIT w PL: tak"] },
        { name: "Bank Pekao", company: "Bank Pekao S.A.", index: 80, badges: ["Siedziba w PL"] },
        { name: "Alior Bank", company: "Alior Bank S.A.", index: 76, badges: ["Siedziba w PL"] },
      ],
    },
    {
      title: "Budowlane",
      ...
      companies: [
        { name: "PSB Mrówka", company: "Grupa PSB S.A.", index: 84, badges: ["Sieć partnerska"] },
        { name: "Castorama", company: "Castorama Polska", index: 40, badges: ["Zatrudnia w PL"] },
        { name: "Leroy Merlin", company: "Leroy Merlin Polska", index: 38, badges: ["Zatrudnia w PL"] },
      ],
    },
  ]
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="max-w-2xl mx-auto mb-8">
            <div className="flex gap-3 mb-4">
              ...
              <Button onClick={handleSearch} className="h-12 px-6 bg-red-600 hover:bg-red-700 text-white">
            ...
            {/* Demo Result Card */}
            {showDemo && (
              <div className="bg-white rounded-lg shadow-lg p-6 border border-slate-200 text-left animate-in slide-in-from-top-4 duration-300">
                        ...
                        <li key={companyIndex} className="border-b border-slate-100 pb-3 last:border-b-0">
                          ...
                          <div className="flex flex-wrap gap-1">
                            {company.badges.slice(0, 2).map((badge, badgeIndex) => (
                              <span key={badgeIndex} className="text-xs bg-slate-100 text-slate-600 px-2 py-1 rounded">
                                {badge}
                              </span>
                            ))}
                          </div>
